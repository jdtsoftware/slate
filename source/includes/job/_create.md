...
url = URI("https://www.thejobspace.com/api/job")
...
conn = http.client.HTTPSConnection("beta.thejobspace.com")
...
curl -X POST \
  ...
  -F benefits=Benefits \
  -F skills=Skills \
  -F open_date=2017-12-01 \
  -F close_date=2018-02-01 \
  -F country_id=229 \
...
`POST https://www.thejobspace.com/api/job`
